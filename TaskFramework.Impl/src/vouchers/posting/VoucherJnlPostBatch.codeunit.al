// PROVIDED (Step 5): public facade for the orchestrator. Forwards to PostBatchImpl.
// Declares the cross-table permissions the whole pipeline needs.
// YOU build the matching "Voucher Jnl.-Post Batch Impl" — see the cheat sheet.
