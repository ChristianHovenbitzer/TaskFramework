// PROVIDED (Step 5): public facade for the Post Line stage. Forwards to the internal
// Impl. Permissions on Voucher Ledger Entry are declared here.
// YOU build the matching "Voucher Jnl.-Post Line Impl" — see the cheat sheet.
