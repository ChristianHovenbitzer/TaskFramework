...
{
    // TODO: (Step 5 - Journal → Posting → Ledger Entry): event signature gained a
    // `var Factory` parameter so subscribers can mutate factory wiring before
    // processing. Caller in ProcessTaskEntry passes Factory through.
